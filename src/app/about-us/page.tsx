  ...
  return (
    <>
      ...
      <section className={styles.bannerWrapper + " flex-column"}>
        <header className={"flex-column justify-center flex-1 flex-grow-1"}>
          ...
          <p className={"text-xl"}>
            ...
            มุ่งมั่นพัฒนาศักยภาพของบุคลากรและสร้างการบริการที่มีคุณค่า
            สร้างคุณภาพที่ดีขึ้น แก่. <br />
      ...
      <section className={styles.serviceSection}>
        <div
          className={`grid gap-20 grid-cols-1 sm:grid-cols-2 md:grid-cols-4`}
        >
      ...
      <section className={`${styles.historySection}`}>
        <div
          className={
            " grid grid-cols-1 ms:grid-cols-2 md:grid-cols-2 xl:grid-cols-2"
          }
        >
          ...
          <div className={"pr-10 p-10 flex-column justify-center"}>
            <h1
              className={"text-3xl font-extrabold underline mb-3 color-primary"}
            >
              บริษัท กรุงไทยธุรกิจลีสซิ่ง จำกัด
            </h1>
            <p className={"text-justify"}>
              บริษัท กรุงไทยธุรกิจลีสซิ่ง จำกัด ก่อตั้งเมื่อเดือนตุลาคม 2548
              เมื่อวันที่ 3 พฤศจิกายน 2557 มีทุนจดทะเบียน 1,000 ล้านบาท
              เมื่อวันที่ 21 พฤษภาคม 2564 โครงสร้างผู้ถือหุ้นของบริษัท โดย
              บมจ.บัตรกรุงไทย ถือหุ้นสัดส่วน 75.05% และ บมจ.ธนาคารกรุงไทย
              ถือหุ้นสัดส่วน 24.95% บริษัทมุ่งให้บริการด้านการเงิน ที่ครบวงจร
              เพื่อตอบสนองความต้องการของลูกค้ากลุ่มต่างๆ
              ทั้งบุคคลธรรมดาและนิติบุคคล
              การดำเนินธุรกิจให้การสนับสนุนทางการเงินประเภท บริการเช่าซื้อ (Hire
              Purchase) บริการเช่าแบบลีสซิ่ง (Financial Lease)
              ด้วยทีมงานและผู้บริหารที่พร้อมด้วยประสบการณ์ความมุ่งมั่น จริงใจ
              ยึดมั่นและมุ่งเน้นที่จะให้บริการเพื่อสนับสนุน
              และตอบสนองความต้องการของลูกค้าให้มีความสะดวกสบาย
              ในฐานะพันธมิตรในการดำเนินธุรกิจที่จะก้าวไกล ไปกับคุณ (GROWING
              TOGETHER)
            </p>
          </div>
        </div>
      ...
      <section className={`${styles.missionSection}`}>
        <div
          className={
            " container mx-auto grid grid-cols-1 ms:grid-cols-2 md:grid-cols-2 xl:grid-cols-2"
          }
        >
          <div className={""}>
            <h1 className={"text-5xl font-bold underline mb-3 color-primary"}>
              ภารกิจ
            </h1>
          </div>
      ...
      <section className={`${styles.coreValueSection}`}>
        <div className={" grid grid-cols-1"}>
          <div className={"pr-10"}>
            <h1
              className={
                "text-4xl font-bold text-center underline mb-3 color-primary"
              }
            >
              ค่านิยมหลัก
            </h1>
            <div
              className={`grid grid-cols-1 ms:grid-cols-2 md:grid-cols-4 xl:grid-cols-4 pt-10`}
            >
              <div
                className={`text-center flex-column justify-center align-center`}
              >
                <Image
                  width={50}
                  height={50}
                ...
                <div>
                  ...
                  <span className={`text-2xl`}>Integrity (ซื่อสัตย์)</span>
                </div>
              </div>
              <div
                className={`text-center flex-column justify-center align-center`}
              >
                ...
                <div>
                  ...
                  <span className={`text-2xl`}>Creativity (สร้างสรรค์)</span>
                </div>
              </div>
              <div
                className={`text-center flex-column justify-center align-center`}
              >
                ...
                <div>
                  ...
                  <span className={`text-2xl`}>Efficiency (สำเร็จ)</span>
                </div>
              </div>
              <div
                className={`text-center flex-column justify-center align-center`}
              >
                ...
                <div>
                  <span className={`text-3xl`}>C</span> :{" "}
                  <span className={`text-2xl`}>Collaboration (ร่วมมือ)</span>
                </div>
              </div>
            </div>
          </div>
