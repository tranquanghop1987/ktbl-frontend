  ...
  return (
    <div className={styles.wrapper}>
      ...
      <section className={styles.contactwrapper}>
        <div className={styles.headtitle}>บริษัท กรุงไทยธุรกิจลีสซิ่ง จำกัด (สำนักงานใหญ่)</div>
        <div className={styles.infoWraper}>
          <div className={styles.block}>
            <p className={styles.title}>โทรศัพท์</p>
            <div>
              <a className="ktfast-normal" href="tel:0 2407 1500" title="ติดต่อ Krungthai Call Center">
                0 2407 1500
              </a>
              <br />
            </div>
          ...
          <div className={styles.block}>
            ...
            <div>
              <a className="ktfast-normal" href="tel:0 2407 1555" title="ติดต่อ Krungthai Call Center">
                0 2407 1555
              </a>
            </div>
          </div>
          <div className={styles.block}>
            ...
            <div>
              <a
                className="ktfast-normal"
                href="mailto:info_ktbleasing@ktbleasing.co.th"
                title="ติดต่อ Krungthai Call Center"
              >
