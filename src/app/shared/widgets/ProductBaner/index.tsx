...
function ProductBaner() {
  ...
  const detailList = [
    ...
    },
    {
      ...
      content:
        "ลดความเสี่ยงจากความผันผวนของอัตราดอกเบี้ย ช่วยเพิ่มประสิทธิภาพในการวางแผน ทางการเงินในอนาคตของกิจการ",
    },
    {
      title: "ลดค่าใช้จ่ายภาษี",
      content:
        "ผลประโยชน์ทางด้านภาษีสามารถใช้เป็นค่าใช้จ่ายในการคำนวนภาษีเงินได้นิติบุคคล (เฉพาะสัญญาเช่าดำเนินงาน)",
    },
    {
    ...
    <div>
        ...
        <div className="container grid md:grid-cols-2 xs:grid-cols-1">
          ...
          <div className={styles.contentRight}>
            <div className={styles.content}>
              ...
              สำหรับการลงทุนในทรัพย์สินเพื่อการใช้งานในกิจการ โดยผู้เช่า
              (Lessee) เป็นผู้เลือกทรัพย์สินที่ ต้องการจากผู้ผลิต หรือผู้ขาย
              ผู้ให้เช่า (Lesser) เป็นผู้ชำระค่าทรัพย์สินนั้นให้แก่ผู้ผลิต
              หรือผู้ขาย ผู้เช่าผ่อนชำระเงินค่าทรัพย์ สินให้แก่
              ผู้ให้เช่าตามสัญญา (กรรมสิทธิ์ทรัพย์สินเป็นของผู้ให้เช่า)
      ...
      <div
        className={`${styles.productInfo}   ${
          inView ? styles.inView : styles.inOut
        }`}
        ref={ref}
      >
            ...
            {detailList.map((item, index) => (
              <li key={index} className={`${styles.itemDetail}  `}>
                ...
                <div>
                  ...
                  <div className={`${styles.contentProduct} mt-4`}>
                    {item.content}
                  </div>
                </div>
              </li>
        ...
        <img
          ...
          src="/assets/images/product_car2.png"
          alt=""
        />
        <img
          className={styles.car1}
          src="/assets/images/product_car1.png"
          alt=""
        />
      </div>
    </div>
